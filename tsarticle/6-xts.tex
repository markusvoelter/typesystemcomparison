...
specified declaratively via a Java API. Later, a DSL was put on top of the
...
At the center of XTS is the \ic{ITypesystem} interface. It has various methods for
...
use the declarative APIs used in the \ic{DefaultTypesystem} implementation.
...
is useful if they have a type) should also be relatively straigthforward. This
...
referenced entities are subtypes of each other. So instead of declaring a subtype relationship
