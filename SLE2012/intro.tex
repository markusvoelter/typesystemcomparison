...
\textbf{Structure} The remainder of the introduction introduces the notion of
...
\todo{where?}. We also provide recommendation on when to use which approach. We
conclude the paper with related work \todo{ref} and a summary \todo{ref}.
