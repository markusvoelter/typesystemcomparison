...
sophisticated, there is a need for efficiently implementing type systems.
...
introduced by Xbase. We will conclude that using DSLs for defining type systems for DSLs is
