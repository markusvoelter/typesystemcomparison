...
Plain & \emph{TypeProvider}, \emph{TypeConformance}, validator: $\approx$11KB\\
Xbase & \emph{JvmModelInferrer}, validator: $\approx$5KB
\\
Xsem & \emph{*.xsemantics} file, validator: $\approx$5KB\\
XTS & \emph{*.ts} file, validator: $\approx$4KB\\
\end{tabularx}
